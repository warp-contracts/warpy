...
describe('Testing warpDiscordBot contract', () => {
  ...
  it('should not allow to start roulette when roulette is not switched on', async () => {
    await expect(
      contract.writeInteraction({ function: 'playRoulette', userId: 'asia', interactionId: '7890' }, { strict: true })
  ...
  it('should not allow to start roulette when interactionId is not passed', async () => {
    await expect(
      contract.writeInteraction({ function: 'playRoulette', userId: 'rouletteUser' }, { strict: true })
  ...
  it('should not allow to start roulette when interactionId is not of type string', async () => {
    await expect(
      contract.writeInteraction(
        { function: 'playRoulette', userId: 'rouletteUser', interactionId: 123 },
        { strict: true }
      )
  ...
  it('should not allow to start roulette when user cannot be found', async () => {
    await expect(
      contract.writeInteraction(
        { function: 'playRoulette', userId: 'rouletteUser non-existing', interactionId: '7890' },
        { strict: true }
      )
  ...
  it(`should not allow to start roulette when user does not have any points`, async () => {
    await expect(
      contract.writeInteraction(
        { function: 'playRoulette', userId: 'rouletteUser', interactionId: '7890' },
        { strict: true }
      )
